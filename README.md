# Patras PM network — PurpleAir sensor QC agent (v2)

Downloads a rolling window of PM data for every active PurpleAir sensor in
the Patras network (selected from your own station spreadsheet, not a map
...
1. Push this folder to a GitHub repo (e.g. `patras-pm-network-v2`).
